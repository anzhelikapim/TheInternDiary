...
- [X] Новая команда `git clone` `git fetch`
##  _День 7-9._
...
- [X] Просмотрела API (задание от Лены)
   ...
   - DRH
## _День 24._
- [X] Пишу раздел _2. Подключение финансирования (лимит, займ и проценты)_ в документацию `PochtaRu`
- [X] Смотрю еще API Почта.Ру (задание от Лены)
- [X] Дополняю табличку по API комментариями 
